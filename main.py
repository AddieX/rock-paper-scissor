#Addie: Don't delete the lib (jerk)
...
class Player:
    ...
    def choose(self):
        while True:
            player_input = input("Please enter your choice (rock, paper, scissors): ").upper()
            if (player_input in self.shapes):
                print(f"User chose: {player_input}")
                return player_input
